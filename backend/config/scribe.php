...
return [
    ...
    'description' => 'REST API for the Hi.Events backend.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
            This documentation is generated from the Laravel route definitions and request validation rules in the backend app.

            <aside>The public API is exposed behind the reverse proxy at <code>/api</code>, even though the Laravel routes themselves are defined without that prefix.</aside>
        INTRO,

    // The base URL displayed in the docs.
    // If you're using `laravel` type, you can set this to a dynamic string, like '{{ config("app.tenant_url") }}' to get a dynamic base URL.
    'base_url' => env('SCRIBE_BASE_URL', rtrim(config('app.frontend_url'), '/') . '/api'),
    ...
    'auth' => [
        ...
        'extra_info' => 'Authenticate by sending a bearer token in the <code>Authorization</code> header. You can obtain one via the login endpoint.',
    ],
